...
const T = {
  fr: {
    title: 'Espace Créateur', subtitle: 'Connecte-toi pour accéder aux offres de collabs',
    email: 'Email', password: 'Mot de passe', submit: 'Se connecter', loading: 'Connexion...',
    pending: 'Compte en attente', noAccount: 'Pas encore inscrit ?', signup: 'Créer un compte',
    back: 'Retour au site', serverErr: 'Erreur de connexion au serveur',
  },
  en: {
    title: 'Creator Space', subtitle: 'Log in to access collab offers',
      ...
      <div className="relative w-full" style={{ maxWidth: 420, padding: '40px 20px' }}>
        ...
        <div className="text-center mt-6 space-y-3">
          <p className="font-dm text-white/30 text-[12px]">
            {t.noAccount}{' '}
            <Link href="/creator" className="text-[#E8471A] hover:brightness-125 transition-all" style={{ textDecoration: 'none' }}>
              {t.signup}
            </Link>
          </p>
