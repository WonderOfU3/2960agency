...
function InscrisRestoPage() {
  ...
  const inputCls = "font-dm w-full rounded-xl text-[14px] text-[#1a1a1a] placeholder:text-[#999] outline-none"
  const inputStyle = { height: 48, padding: '0 16px', background: '#fff', border: '1px solid #d4d4d4' }

  return (
    <div className="min-h-screen" style={{ background: '#fafaf8', color: '#1a1a1a', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <StickyMobileCta />

      {/* Nav */}
      <nav className="flex items-center justify-between px-5 sm:px-8" style={{ height: 64 }}>
        <Link href="/" className="font-buster text-[18px] sm:text-[22px] text-[#1a1a1a]" style={{ textDecoration: 'none' }}>
          2960 AGENCY
        </Link>
      ...
      <section className="px-5 sm:px-8 pt-16 sm:pt-24 pb-12 sm:pb-20" style={{ maxWidth: 820, margin: '0 auto' }}>
        <h1 className="font-dm text-[#1a1a1a] text-[28px] sm:text-[44px] font-bold leading-[1.15] tracking-tight mb-5 sm:mb-6">
          Vous offrez un repas.<br />Ils publient une vidéo TikTok.
        </h1>
        <p className="font-dm text-[#555] text-[15px] sm:text-[17px] leading-[1.7] mb-8 sm:mb-10" style={{ maxWidth: 640 }}>
        ...
        <CtaButton />
        <p className="font-dm text-[#999] text-[13px] mt-4">{CTA_SUB}</p>
      </section>

      {/* ═══════════════ COMMENT ÇA MARCHE ═══════════════ */}
      <section className="px-5 sm:px-8 py-16 sm:py-24" style={{ background: '#f3f2ef' }}>
          ...
          <div className="space-y-10 sm:space-y-14">
            ...
            <div className="flex gap-4 sm:gap-6">
              <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-dm text-[14px] sm:text-[16px] font-bold"
                style={{ background: 'rgba(232,71,26,0.10)', color: '#E8471A' }}>1</div>
              <div>
                <h3 className="font-dm text-[#1a1a1a] text-[17px] sm:text-[20px] font-bold mb-2">Vous créez votre offre en 5 minutes</h3>
                <p className="font-dm text-[#666] text-[14px] sm:text-[15px] leading-[1.7]">
            ...
            <div className="flex gap-4 sm:gap-6">
              <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-dm text-[14px] sm:text-[16px] font-bold"
                style={{ background: 'rgba(232,71,26,0.10)', color: '#E8471A' }}>2</div>
              <div>
                <h3 className="font-dm text-[#1a1a1a] text-[17px] sm:text-[20px] font-bold mb-2">Un créateur vérifié réserve</h3>
                <p className="font-dm text-[#666] text-[14px] sm:text-[15px] leading-[1.7]">
            ...
            <div className="flex gap-4 sm:gap-6">
              <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-dm text-[14px] sm:text-[16px] font-bold"
                style={{ background: 'rgba(232,71,26,0.10)', color: '#E8471A' }}>3</div>
              <div>
                <h3 className="font-dm text-[#1a1a1a] text-[17px] sm:text-[20px] font-bold mb-2">La vidéo est publiée</h3>
                <p className="font-dm text-[#666] text-[14px] sm:text-[15px] leading-[1.7]">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24">
        <div style={{ maxWidth: 820, margin: '0 auto' }} className="space-y-12 sm:space-y-16">
          <div>
            <h3 className="font-dm text-[#1a1a1a] text-[18px] sm:text-[22px] font-bold mb-3 leading-tight">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24" style={{ background: '#f3f2ef' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          ...
          <h2 className="font-dm text-[#1a1a1a] text-[22px] sm:text-[30px] font-bold leading-tight mb-5">
          ...
          {/* Grid */}
          <div className="rounded-2xl p-5 sm:p-6 mb-6" style={{ background: '#fff', border: '1px solid #e5e5e5' }}>
            <p className="font-dm text-[#999] text-[11px] uppercase tracking-[0.12em] mb-4">Grille utilisée par d&apos;autres restos 2960</p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                <div key={t.views} className="rounded-xl p-3 text-center" style={{ background: 'rgba(232,71,26,0.06)', border: '1px solid rgba(232,71,26,0.15)' }}>
                  <p className="font-dm text-[#444] text-[13px] font-semibold">{t.views} vues</p>
                  <p className="font-dm text-[#E8471A] text-[18px] font-bold mt-1">{t.prime}</p>
                </div>
              ))}
            </div>
          </div>
          <p className="font-dm text-[#888] text-[13px] leading-[1.7] mb-8">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24">
        <div style={{ maxWidth: 820, margin: '0 auto' }} className="text-center">
          <h2 className="font-dm text-[#1a1a1a] text-[22px] sm:text-[30px] font-bold leading-tight mb-4">
            3 collabs sans abonnement pour commencer.
          </h2>
          <p className="font-dm text-[#666] text-[14px] sm:text-[16px] leading-[1.7] mb-8" style={{ maxWidth: 560, margin: '0 auto 32px' }}>
      ...
      {/* ═══════════════ FORMULAIRE ═══════════════ */}
      <section id="form" className="px-5 sm:px-8 py-16 sm:py-24" style={{ background: '#f3f2ef' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <h2 className="font-dm text-[#1a1a1a] text-[22px] sm:text-[28px] font-bold text-center mb-8">
            Créez votre compte restaurant
          </h2>

          <div className="space-y-4">
            <div data-e={errors.email ? '' : undefined}>
              <label className="font-dm text-[#555] text-[11px] font-semibold uppercase tracking-[0.06em] block mb-1.5">Email <span className="text-[#E8471A]">*</span></label>
              <input type="email" value={form.email} onChange={e => set('email', e.target.value)} placeholder="contact@exemple.com"
                className={inputCls} style={inputStyle} />
              {errors.email && <p className="font-dm text-[#E8471A] text-[11px] mt-1">{errors.email}</p>}
            </div>

            <div data-e={errors.bizName ? '' : undefined}>
              <label className="font-dm text-[#555] text-[11px] font-semibold uppercase tracking-[0.06em] block mb-1.5">Nom du restaurant <span className="text-[#E8471A]">*</span></label>
            ...
            <div data-e={errors.password ? '' : undefined}>
              <label className="font-dm text-[#555] text-[11px] font-semibold uppercase tracking-[0.06em] block mb-1.5">Mot de passe <span className="text-[#E8471A]">*</span></label>
              ...
              {errors.password && <p className="font-dm text-[#E8471A] text-[11px] mt-1">{errors.password}</p>}
            </div>
            {/* Referral code */}
            <div>
              {!showReferral ? (
                <button type="button" onClick={() => setShowReferral(true)}
                  className="font-dm text-[#888] text-[12px] underline cursor-pointer bg-transparent border-none p-0">
                  J&apos;ai un code de parrainage
                </button>
              ) : (
                <div>
                  <label className="font-dm text-[#555] text-[11px] font-semibold uppercase tracking-[0.06em] block mb-1.5">Code de parrainage <span className="text-[#999] normal-case">(optionnel)</span></label>
                  <input value={referralCode} onChange={e => setReferralCode(e.target.value.toUpperCase())} placeholder="Ex : ABC123"
                    className={inputCls} style={inputStyle} />
                  <p className="font-dm text-[#999] text-[10px] mt-1">Votre inscription sera associée au créateur référent.</p>
                </div>
              )}
            </div>
          </div>
          ...
          {globalError && (
            <p className="font-dm text-[#E8471A] text-[13px] text-center mt-3">{globalError}</p>
          )}

          {/* Legal */}
          <p className="font-dm text-[#999] text-[11px] leading-relaxed mt-4 text-center">
      ...
      <footer className="px-5 sm:px-8 py-8 text-center" style={{ borderTop: '1px solid #e5e5e5' }}>
        <Link href="/" className="font-buster text-[14px] text-[#bbb] hover:text-[#888] transition-colors" style={{ textDecoration: 'none' }}>
          2960 AGENCY
        </Link>
      </footer>
    </div>
