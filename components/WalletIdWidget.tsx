...
const T = {
  fr: {
    ...
    copied: 'Copié !',
    walletSoon: 'Apple Wallet & Google Wallet — bientôt disponible',
  },
  en: {
    ...
    copied: 'Copied!',
    walletSoon: 'Apple Wallet & Google Wallet — coming soon',
  },
}
...
export default function WalletIdWidget() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden mb-6" style={{ background: '#6d0040', border: '1px solid rgba(255,99,57,0.2)' }}>
      ...
      <div className="px-5 py-3" style={{ background: 'rgba(0,0,0,0.2)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
